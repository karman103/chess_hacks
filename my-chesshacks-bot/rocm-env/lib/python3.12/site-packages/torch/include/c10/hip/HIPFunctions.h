...
C10_HIP_API hipError_t GetDevice(DeviceIndex* device);

C10_HIP_API hipError_t SetDevice(DeviceIndex device);

C10_HIP_API hipError_t MaybeSetDevice(DeviceIndex device);

C10_HIP_API DeviceIndex ExchangeDevice(DeviceIndex device);

C10_HIP_API DeviceIndex MaybeExchangeDevice(DeviceIndex device);
...
C10_HIP_API std::optional<DeviceIndex> getDeviceIndexWithPrimaryContext();
