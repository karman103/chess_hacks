...
struct GemmParams : OpParams {
  ...
  GemmParams* DeepCopy(bool duplicate_inputs) const {
    ...
    *copy = *this;
    ...
    copy->c = static_cast<T*>(c10::hip::HIPCachingAllocator::raw_alloc(c_size));
    AT_CUDA_CHECK(c10::hip::HIPCachingAllocator::memcpyAsync(
    ...
    if (duplicate_inputs) {
      ...
      copy->a = static_cast<const T*>(c10::hip::HIPCachingAllocator::raw_alloc(a_size));
      copy->b = static_cast<const T*>(c10::hip::HIPCachingAllocator::raw_alloc(b_size));
  ...
  void Delete() {
    c10::hip::HIPCachingAllocator::raw_delete(c);
    if (duplicate_inputs_) {
      c10::hip::HIPCachingAllocator::raw_delete(const_cast<T*>(a));
      c10::hip::HIPCachingAllocator::raw_delete(const_cast<T*>(b));
    }
  }
...
struct ScaledGemmParams : OpParams {
  ...
  ScaledGemmParams* DeepCopy(bool duplicate_inputs) const {
    ...
    *copy = *this;
    ...
    AT_CUDA_CHECK(c10::hip::GetDevice(&device));
    size_t c_size = GetSizeC();
    copy->c = c10::hip::HIPCachingAllocator::raw_alloc(c_size);
    AT_CUDA_CHECK(c10::hip::HIPCachingAllocator::memcpyAsync(
        copy->c, device, c, device, c_size, getCurrentHIPStreamMasqueradingAsCUDA(device), true));
    if (duplicate_inputs) {
      size_t a_size = GetSizeA();
      size_t b_size = GetSizeB();
      copy->a = c10::hip::HIPCachingAllocator::raw_alloc(a_size);
      copy->b = c10::hip::HIPCachingAllocator::raw_alloc(b_size);
      copy->duplicate_inputs_ = true;
    }
    return copy;
  }
  ...
  void Delete() {
    c10::hip::HIPCachingAllocator::raw_delete(c);
    if (duplicate_inputs_) {
      c10::hip::HIPCachingAllocator::raw_delete(const_cast<void*>(a));
      c10::hip::HIPCachingAllocator::raw_delete(const_cast<void*>(b));
    }
  }
