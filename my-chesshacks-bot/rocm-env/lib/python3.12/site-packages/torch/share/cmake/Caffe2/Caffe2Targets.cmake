...
foreach(_expectedTarget c10_hip c10 torch_cpu torch_cpu_library torch_hip torch_hip_library torch torch_library)
...
set_target_properties(c10_hip PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "c10;/opt/rocm/lib/libamdhip64.so"
)
...
# Create imported target torch_hip
add_library(torch_hip SHARED IMPORTED)

set_target_properties(torch_hip PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "USE_C10D_NCCL"
  INTERFACE_COMPILE_OPTIONS "-fPIC;-D__HIP_PLATFORM_AMD__=1;-DCUDA_HAS_FP16=1;-DUSE_ROCM;-D__HIP_NO_HALF_OPERATORS__=1;-D__HIP_NO_HALF_CONVERSIONS__=1;-DTORCH_HIP_VERSION=600;-Wno-shift-count-negative;-Wno-shift-count-overflow;-Wno-duplicate-decl-specifier;-DCAFFE2_USE_MIOPEN;-DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_HIP;-std=c++17;-DHIPBLAS_V2;-DHIP_NEW_TYPE_ENUMS"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "c10_hip;torch_cpu_library;/opt/rocm/lib/libamdhip64.so;MIOpen;/opt/rocm/lib/libhiprtc.so;/opt/rocm/lib/libroctx64.so;roc::hipblaslt;roc::hipblas;hip::hipfft;hip::hiprand;roc::hipsparse;roc::hipsolver"
)

# Create imported target torch_hip_library
add_library(torch_hip_library INTERFACE IMPORTED)

set_target_properties(torch_hip_library PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<TARGET_PROPERTY:torch_hip,INTERFACE_COMPILE_DEFINITIONS>"
  INTERFACE_COMPILE_OPTIONS "\$<TARGET_PROPERTY:torch_hip,INTERFACE_COMPILE_OPTIONS>"
  INTERFACE_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_hip,INTERFACE_INCLUDE_DIRECTORIES>"
  INTERFACE_LINK_LIBRARIES "-Wl,--no-as-needed,\"\$<TARGET_FILE:torch_hip>\" -Wl,--as-needed;\$<TARGET_PROPERTY:torch_hip,INTERFACE_LINK_LIBRARIES>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "\$<TARGET_PROPERTY:torch_hip,INTERFACE_SYSTEM_INCLUDE_DIRECTORIES>"
)
...
set_target_properties(torch PROPERTIES
  INTERFACE_LINK_LIBRARIES "torch_cpu_library;torch_hip_library"
)
